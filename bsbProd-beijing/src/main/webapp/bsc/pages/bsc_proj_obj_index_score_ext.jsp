...
<html>
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/bsc/scripts/bsc_proj_obj_index_score_ext_layout.js"></script>
	</head>
  
  	<body>
	  	<!-- 导出Excel文件Form -->
	  	<form id="excelForm" name="excelForm" action="bscresult_exportScoreByCondExt.action" method="post" target="">
